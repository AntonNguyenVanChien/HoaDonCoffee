...
# phần soBan
soBanLabel = Label(ThongTinKhachHang, text='Bàn', font=('times new roman', 15, 'bold'), bg=mau_nen,
                   fg='white')
...
searchButton.grid(row=0, column=6, padx=30, )
...
clearButton = Button(buttonFrame, text='Xóa', font=('arial', 16, 'bold'), bg=mau_nen, fg='white', bd=5, width=8,command=clear)
